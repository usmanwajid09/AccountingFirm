  ...
  return (
    <section className="bg-ia-blue py-16 md:py-20 text-center relative z-10 overflow-hidden reveal">
      <div className="container max-w-[800px] mx-auto flex flex-col items-center justify-center">
        <h2 className="text-[28px] md:text-[36px] font-bold text-ia-white leading-tight mb-4">
          {title}
        </h2>
        <p className="text-[17px] text-ia-white/85 font-light leading-relaxed mb-8 max-w-[620px]">
          {sub}
        </p>
        <Button href={btnHref} variant="inverse">
          {btnText}
        </Button>
      </div>
    </section>

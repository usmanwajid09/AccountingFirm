...
export default function Home() {
  ...
  return (
    <>
        ...
        <div className="container max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-8 text-left flex flex-col gap-8 relative">
              ...
              <h1 className="text-[34px] sm:text-[60px] lg:text-[80px] xl:text-[92px] font-extrabold text-ia-white leading-[0.92] tracking-tighter max-w-[1000px] relative uppercase z-10">
              ...
              <div className="relative z-10 inline-flex flex-wrap items-center gap-2.5 bg-ia-blue/10 border border-ia-blue/30 px-5 py-2.5 rounded-lg text-ia-blue font-bold text-[16px] sm:text-[19px] max-w-fit shadow-sm">
                <span>Accounts &amp; Tax Return From</span>
                <span className="bg-ia-blue text-ia-navy px-3 py-0.5 rounded font-extrabold text-[18px]">£199</span>
                <span>Per Year</span>
              </div>

              <p className="text-[17px] sm:text-[19px] text-ia-text-secondary font-light leading-relaxed max-w-[680px] relative z-10 gsap-reveal">
      ...
      {/* 6. Pricing Section */}
      <section className="bg-ia-navy py-24 relative overflow-hidden border-b border-ia-border/30" id="pricing">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
            ...
            <div className="bg-ia-navy-alt/90 backdrop-blur-md border border-ia-border/80 rounded-2xl p-8 flex flex-col h-full shadow-card hover:border-ia-blue/40 transition-all duration-300 relative group/card">
              ...
              <Link
                ...
                className="w-full inline-flex items-center justify-center bg-white/5 hover:bg-ia-blue border border-white/20 hover:border-ia-blue text-white hover:text-ia-navy font-bold py-3.5 px-6 rounded-md text-[14px] uppercase tracking-wider transition-all duration-200 text-center"
              >
                Get Started Today
              </Link>
            </div>
            ...
            <div className="bg-gradient-to-b from-[#0d9488] via-[#0f766e] to-[#115e59] text-white rounded-2xl p-8 flex flex-col h-full shadow-[0_0_40px_rgba(13,148,136,0.35)] border border-[#2dd4bf]/40 relative transform lg:-translate-y-3 z-10">
              {/* Popular Badge */}
              ...
              <Link
                href="/contact?service=Business%20Package"
                className="w-full inline-flex items-center justify-center bg-amber-400 hover:bg-amber-300 text-ia-navy font-extrabold py-3.5 px-6 rounded-md text-[14px] uppercase tracking-wider shadow-md transition-all duration-200 text-center"
              >
                Choose Package
              </Link>
            </div>
